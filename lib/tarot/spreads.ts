...
export const SPREADS: SpreadType[] = [
  {
    ...
    duration: '2 мин',
    positions: [
      { index: 1, title: 'Прошлое', hint: 'Корни ситуации' },
      { index: 2, title: 'Настоящее', hint: 'Что происходит сейчас' },
      { index: 3, title: 'Будущее', hint: 'К чему движешься' },
    ],
  },
  {
    id: 'five-cards',
  ...
  },
  {
    ...
    duration: '4 мин',
    positions: [
      { index: 1, title: 'Прошлое', hint: 'Откуда пришёл' },
      { index: 2, title: 'Настоящее', hint: 'Где находишься' },
...
/** Темы вопросов (как на taroyal.ru) */
export const THEMES = [
